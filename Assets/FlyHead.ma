...
//Name: FlyHead.ma
//Last modified: Sun, Jun 02, 2013 03:55:55 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -77.829152146075145 5.3655545133483642 -4.0788530274741355 ;
	setAttr ".r" -type "double3" -3.9383527300453434 266.99999999998812 0 ;
	setAttr ".rp" -type "double3" -2.9865473696379287e-15 1.2624179366844138e-16 7.1054273576010019e-15 ;
	setAttr ".rpt" -type "double3" 5.3793888175113815e-15 1.6011926379533925e-14 1.3514323556057994e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 78.120439969526316;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.4868995751603507e-14 -1.0658141036401503e-14 -1.4210854715202004e-14 ;
...
createNode transform -n "group9";
	setAttr ".rp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
	setAttr ".sp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
createNode transform -n "pasted__group8" -p "group9";
	setAttr ".rp" -type "double3" -0.87459287888543735 1.8479934275353109 -1.5354400527519021 ;
	setAttr ".sp" -type "double3" -0.87459287888543735 1.8479934275353109 -1.5354400527519021 ;
createNode transform -n "pasted__pasted__group3" -p "pasted__group8";
	setAttr ".rp" -type "double3" 3.8155562923930324 -2.9341098252342528 -2.8520598609818091 ;
	setAttr ".sp" -type "double3" 3.8155562923930324 -2.9341098252342528 -2.8520598609818091 ;
createNode transform -n "pasted__pasted__pasted__group1" -p "pasted__pasted__group3";
	setAttr ".rp" -type "double3" 0.21778888681577691 2.0650962478399384 -3.0036970884413012 ;
	setAttr ".sp" -type "double3" 0.21778888681577691 2.0650962478399384 -3.0036970884413012 ;
...
createNode transform -n "pasted__pasted__pasted__pasted__pCylinder1" -p "group18";
	setAttr ".t" -type "double3" -3.0701326540058496 2.2057157573006325 1.4844907167149715 ;
	setAttr ".s" -type "double3" 0.36850829790832779 1.0894312412730423 0.99877172487715626 ;
...
createNode transform -n "pasted__pCone1" -p "group18";
	...
	setAttr ".s" -type "double3" 0.74214404930778777 0.74214404930778777 0.74214404930778777 ;
...
createNode transform -n "group13";
	...
	setAttr ".rp" -type "double3" -1.5278335635690161 2.1746434066389835 -2.4047136729497058 ;
	setAttr ".sp" -type "double3" -1.5278335635690161 2.1746434066389835 -2.4047136729497058 ;
createNode transform -n "pasted__group9" -p "group13";
	setAttr ".rp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
	setAttr ".sp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
createNode transform -n "pasted__group10" -p "|group13|pasted__group9";
createNode transform -n "pasted__group11" -p "|group13|pasted__group9|pasted__group10";
createNode transform -n "pasted__group12" -p "|group13|pasted__group9|pasted__group10|pasted__group11";
createNode transform -n "pasted__pasted__pasted__pasted__pasted__pCylinder1" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12";
	setAttr ".t" -type "double3" -1.9262372422043699 0.90784391662467634 -3.0559866240206173 ;
	setAttr ".s" -type "double3" 0.36850829790832779 1.0894312412730423 0.99877172487715626 ;
createNode mesh -n "pasted__pasted__pasted__pasted__pasted__pCylinderShape1" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pasted__pasted__pasted__pCylinder1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pasted__pasted__pCone1" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12";
	setAttr ".t" -type "double3" 5.9254983544482913 -0.17491705861736362 -1.1803256329939646 ;
	setAttr ".r" -type "double3" 180 0 90 ;
	setAttr ".s" -type "double3" 0.74214404930778777 0.74214404930778777 0.74214404930778777 ;
createNode mesh -n "pasted__pasted__pConeShape1" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pCone1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr -s 21 ".pt[0:20]" -type "float3"  1.6111186 -6.882163 2.4729228 
		...
		1.5530009 -6.882163 2.6517954 1.5883973 -6.882163 2.6163988 1.6111188 -6.882163 2.5718002 
		1.6189506 -6.882163 2.5223618 1.4589636 -6.29987 2.5223618;
createNode transform -n "pasted__pasted__pSphere2" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12";
	setAttr ".t" -type "double3" -0.42558052761865972 0.90784394246667444 -3.0559862316114259 ;
	setAttr ".s" -type "double3" 1.294180717073798 0.7493214509414089 0.8324538046749419 ;
createNode mesh -n "pasted__pasted__pSphereShape2" -p "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pSphere2";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pasted__group9" -p "group16";
	setAttr ".rp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
	setAttr ".sp" -type "double3" 1.336858062954053 1.9082160362509306 -2.404713692922769 ;
createNode transform -n "pasted__group10" -p "|group16|pasted__group9";
createNode transform -n "pasted__group11" -p "|group16|pasted__group9|pasted__group10";
createNode transform -n "pasted__group12" -p "|group16|pasted__group9|pasted__group10|pasted__group11";
createNode transform -n "pasted__group15" -p "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12";
createNode transform -n "pasted__pasted__pasted__pasted__pasted__pCylinder1" -p "pasted__group15";
	setAttr ".t" -type "double3" -3.0701326540058496 0.9078437573006326 2.5355178969300849 ;
	setAttr ".s" -type "double3" 0.36850829790832779 1.0894312412730423 0.99877172487715626 ;
createNode mesh -n "pasted__pasted__pasted__pasted__pasted__pCylinderShape1" -p "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pasted__pasted__pasted__pCylinder1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pasted__pasted__pSphere2" -p "pasted__group15";
	setAttr ".t" -type "double3" -1.5694759394201394 0.9078438931426307 2.5355182893392763 ;
	setAttr ".s" -type "double3" 1.294180717073798 0.7493214509414089 0.8324538046749419 ;
createNode mesh -n "pasted__pasted__pSphereShape2" -p "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pSphere2";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pasted__pasted__pCone1" -p "pasted__group15";
	...
	setAttr ".r" -type "double3" 180 0 90 ;
	setAttr ".s" -type "double3" 0.74214404930778777 0.74214404930778777 0.74214404930778777 ;
createNode mesh -n "pasted__pasted__pConeShape1" -p "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pCone1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pasted__pCube2" -p "group21";
	...
	setAttr ".s" -type "double3" 0.68270045723319306 0.95060173969649642 1.8359332474704031 ;
...
connectAttr "pasted__pasted__pasted__pasted__pasted__polyCylinder4.out" "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pasted__pasted__pasted__pCylinder1|pasted__pasted__pasted__pasted__pasted__pCylinderShape1.i"
		;
connectAttr "pasted__pasted__polyCone1.out" "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pCone1|pasted__pasted__pConeShape1.i"
		;
connectAttr "pasted__pasted__polySphere2.out" "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pSphere2|pasted__pasted__pSphereShape2.i"
		;
connectAttr "pasted__pasted__pasted__pasted__pasted__polyCylinder6.out" "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pasted__pasted__pasted__pCylinder1|pasted__pasted__pasted__pasted__pasted__pCylinderShape1.i"
		;
connectAttr "pasted__pasted__polySphere4.out" "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pSphere2|pasted__pasted__pSphereShape2.i"
		;
connectAttr "pasted__pasted__polyCone3.out" "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pCone1|pasted__pasted__pConeShape1.i"
		;
...
connectAttr "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pCone1|pasted__pasted__pConeShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pasted__pasted__pasted__pCylinder1|pasted__pasted__pasted__pasted__pasted__pCylinderShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group13|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__pasted__pSphere2|pasted__pasted__pSphereShape2.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pCone1|pasted__pasted__pConeShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pasted__pasted__pasted__pCylinder1|pasted__pasted__pasted__pasted__pasted__pCylinderShape1.iog" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|group16|pasted__group9|pasted__group10|pasted__group11|pasted__group12|pasted__group15|pasted__pasted__pSphere2|pasted__pasted__pSphereShape2.iog" ":initialShadingGroup.dsm"
		 -na;
